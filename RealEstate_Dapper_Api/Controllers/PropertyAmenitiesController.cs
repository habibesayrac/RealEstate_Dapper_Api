...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class PropertyAmenitiesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> ResultPropertyAmenityStatusByTrue(int id)
        {
            var values = await _propertyAmenityRepository.ResultPropertyAmenityStatusByTrue(id);
            return Ok(values);
        }
    }
}